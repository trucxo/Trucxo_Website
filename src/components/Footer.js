                    ...
                    <div className="grid sm:grid-cols-12 gap-5 py-8 md:py-12 border-t border-black lg:ml-11">
                        ...
                        <div className="col-span-6 md:col-span-6 lg:col-span-1 ml-7 mx-auto">
                            ...
                            <ul className="text-md">
                                <li className="mb-2">
                                    <HashLink to="/contact" className="text-[#000000] hover:text-black hover:tracking-wider transition duration-250 ease-in-out">Contact</HashLink>
                                </li>
                                <li className="mb-2">
                                    <Link to="/privacy-policy" className="text-[#000000] hover:text-black">Privacy Policy</Link>
                                </li>
                                <li className="mb-2">
                                    <Link to="/refund-policy" className="text-[#000000] hover:text-black">Refund Policy</Link>
                                </li>
                                <li className="mb-2">
                                    <Link to="/terms-and-conditions" className="text-[#000000] hover:text-black">Terms & Conditions</Link>
                                </li>
                                <li className="mb-2">
                        ...
                        <div className="col-span-12 text-center mx-auto lg:col-span-3 font-bold uppercase text-black-900">
                            ...
                            <div className="mx-auto text-center mt-2">
                                <ul className="flex justify-center mb-4 md:mb-0">
                                    <li>
                                        <a href="https://www.linkedin.com/in/trucxo-company-a61912348/" target="_blank" rel="noreferrer" className="rounded-full flex hover:bg-white-100 justify-center bg-white h-8 text-black  w-8  mx-1 text-center pt-1">
